<template>
	<div class="shopcart">
		<div class="content" @click="toggleShow">
			...
			<div class="content-right">
				<div class="pay" :class="payClass" @click.stop="pay">{{priceDesc}}</div>
			</div>
		</div>
	...
	<div class="list-mask" v-show="listShow" transition="fade" @click="toggleShow"></div>
</template>
<script>
	...
	.shopcart
		...
		.ball-container
			.ball
				...
				z-index: 200
				&.drop-transition
					transition: all 0.4s cubic-bezier(.78,-0.18,1,.79)
					.inner
						display: inline-block
						width: 16px
						height:16px
